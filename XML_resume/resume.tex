...
\begin{document}\section{Education}
\begin{schools}{Aug 2016 - Present}

    \school{name={Georgia Institute of Technology},loc={Atlanta, GA},from={Aug 2016},to={Present},major={Mechanical Engineering},minor={Robotics},year={},gpa={3.58},grad={}}
  
\end{schools}
  \section{Academic Projects}\experience{corp={GT Motorsports},pos={Powertrain Team Member},from={Aug 2016},to={Present}}\begin{itemize}
...
\end{skills}
  \section{Awards \& Honors}\end{document}