...
\begin{skills}{Microcontrollers}
  \skill{CAD}{Solidworks(7 years), Autodesk~Inventor(8 years), Top-down~Design, Parametric~Design, Surface~Modeling, 2D~Engineering~Drawings}
  \skill{Manufacturing}{Haas CNC, Manual Mill, Manual Lathe, Laser Cutter, Waterjet, 3D Printer}
  \skill{Programming}{MatLab, Java, Python, HTML, CSS, SASS, Android, \LaTeX}
  \skill{Microcontrollers}{Arduino, NI myRio/roboRio(LabView)}
  \skill{Software}{Vim, Adobe Illustrator, Word, Excel}
\end{skills}
